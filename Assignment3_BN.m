...
% Gradient Check
%[h, S, sbar, sw, mu, v] = intervalues(trainX(:, 1:20), Netparams.W, Netparams.b, k, Netparams);
%P = EvaluateClassifier(h, Netparams.W, Netparams.b);
%[grad_W, grad_b, grad_gammas, grad_betas] = ComputeGradients(trainX(:, 1:20), trainY(:, 1:20), h, S, sbar, P, Netparams.W, lambda, k, Netparams, mu, v);
