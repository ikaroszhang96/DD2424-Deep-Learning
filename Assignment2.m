...
W1 = 1 / sqrt(3072) * randn(m, d);
W2 = 1 / sqrt(50) * randn(K, m);
...
%valA = zeros(1, GDparams.n_epochs + 1);
...
% plot
%figure()
%plot(0 : GDparams.n_epochs, trainA, 'r')
%hold on
%plot(0 : GDparams.n_epochs, valA, 'b')
%hold off
%xlabel('epoch');
%ylabel('accuracy');
